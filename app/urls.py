...
urlpatterns = [
    ...
    path('forms/formone/one',views.moreformonea,name='IIformtwoa'),
    path('forms/formone/two',views.moreformoneb,name='IIformtwob'),
    path('forms/formone/three',views.moreformonec,name='IIformtwoc'),
